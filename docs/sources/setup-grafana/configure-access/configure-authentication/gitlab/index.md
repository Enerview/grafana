...
| `default_team`               | No       | No                 | Name of an existing Grafana team that users authenticating with this provider are added to on every login. The team must already exist in the organization the user signs in to. Existing members are never removed, so clearing this setting leaves previously assigned memberships in place.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |                                      |
